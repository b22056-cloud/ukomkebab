# 🌾 UKOM RAMA - Sistem Manajemen Data Produk Panen
...
Aplikasi Web Manajemen Data Produk Panen berbasis **Native PHP REST API** dan **Frontend JavaScript ES6**. Proyek ini dikembangkan sebagai tugas Soal Praktik **Uji Kompetensi Keahlian (UKOM)** Skema **Junior Web Programmer**.

---

## 📌 Identitas Peserta & Proyek

* **Nama Peserta:** Zulkifli Ramadhani
* **Paket / Skema:** Junior Web Programmer
...
Dibuat dengan ❤️ oleh **Zulkifli Ramadhani** © 2026.